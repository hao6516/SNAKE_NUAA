...
import './style.less';
const snakeHead = require('../../resources/images/snake_head.png')
...
> {
  ...
  getSnakePosition = ({ x, y }: IStartNode, index: Number) => {
    if (index === 0) {
      return { transform: `translate(${y * 16}px, ${x * 16}px)`, backgroundColor: 'white' };
    }
      ...
      <div className='left' id='left'>
        ...
        gameInit === 1 &&
          snake.map((item, i) => {
            ...
            return (
              ...
              >
                <img src={snakeHead} alt="" style={{width:15, height:15}}/>
              </div>
            );
          })}
        {/*食物*/
        gameInit === 1 && (
          <div
            ...
            className={` ${showFood ? 'food-o-cell' : 'food-cell'}`}> 
  <img src={snakeHead} alt="" style={{width:15, height:15}}/>
            </div>
        )}
        {/*初始化和失败条件下页面动画*/
